...
gui: src/gui.cpp build/render_ffmpeg.o lib/imgtools.a
	g++ -g -o bin/gui src/gui.cpp lib/imgtools.a build/render_ffmpeg.o -O2 `pkg-config --cflags eigen3` -lnanogui -ldl -lGL -lavcodec -lswscale -lavutil -lavformat `pkg-config --cflags --libs opencv4`
